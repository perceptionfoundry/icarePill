...
class ScanNumberViewController: UIViewController {
	// MARK: - UI objects
...
//        view.addSubview(cutout)
        ...
        captureSessionQueue.async {
            ...
            DispatchQueue.main.async {
                ...
                self.request = VNRecognizeTextRequest(completionHandler: self.recognizeTextHandler)
            }
        }
	}
    ...
    func recognizeTextHandler(request: VNRequest, error: Error?) {
        ...
        show(self, sender: [(color: UIColor.red.cgColor, boxes: redBoxes), (color: UIColor.green.cgColor, boxes: greenBoxes)])
...
extension ScanNumberViewController: AVCaptureVideoDataOutputSampleBufferDelegate {
